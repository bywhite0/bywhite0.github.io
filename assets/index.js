function showsth(){
	...
	avatar = mdui.$("img#loveAvatar");
	time.removeClass("mdui-hidden");
	avatar.removeClass("mdui-hidden");
	time.mutation();
	avatar.mutation();
};
function devtEruda(){
...
url: 'http://antiserver.kuwo.cn/anti.s?useless=/resource/&format=mp3&rid=MUSIC_187582414&response=res&type=convert_url',
cover: 'http://p2.music.126.net/jkmwhYe2k0oONjJr0WWCmg==/18776360069542158.jpg',
theme: '#000000',
